...
CREATE TABLE IF NOT EXISTS `{PREFIX}lands` (
    ...
    `guild` UUID NULL,
    `claimedBy` UUID NULL,
--    `structures` JSON NULL, `turrets` JSON NULL,
...
--    CONSTRAINT location PRIMARY KEY (id_world, id_x, id_y, id_z)
--    --private @NonNull Map<UUID, Boolean> players, guilds;
--) STRICT;
...
--    `book` JSON NULL,
    ...
    CONSTRAINT `{PREFIX}guilds_pkey` PRIMARY KEY (`id`)
) STRICT;

--CREATE TABLE IF NOT EXISTS `{PREFIX}guilds_members` (
--    id UUID PRIMARY KEY NOT NULL,
--    id UUID NOT NULL
--) STRICT;
--CREATE TABLE IF NOT EXISTS `{PREFIX}guilds_lands` (
--    id UUID NOT NULL,
--    SimpleChunkLocation(id) NOT NULL,
--    CONSTRAINT location PRIMARY KEY (id_world, id_x, id_z)
--) STRICT;
---- protected @NonNull Map<UUID, guildRelationshipRequest> relationshipRequests;
---- protected @NonNull Map<UUID, guildRelation> relations;
--CREATE TABLE IF NOT EXISTS `{PREFIX}guilds_relations` (
--    id UUID PRIMARY KEY NOT NULL,
--    id UUID NOT NULL,
--    relation VARCHAR(50) NOT NULL
--) STRICT;
---- Map<guildRelation, Set<RelationAttribute>> attributes;
--CREATE TABLE IF NOT EXISTS `{PREFIX}guilds_attributes` (
--    entry VARCHAR(50) PRIMARY KEY NOT NULL,
--    relation VARCHAR(50) NOT NULL,
--    guild UUID NOT NULL
--) STRICT;
---- LinkedList<AuditLog> logs;
--CREATE TABLE IF NOT EXISTS `{PREFIX}guilds_logs` (
--    guild UUID NOT NULL,
--    json JSON NOT NULL
--) STRICT;
--CREATE TABLE IF NOT EXISTS `{PREFIX}guilds_ranks` (
--    guild UUID NOT NULL,
...
--) STRICT;
--CREATE TABLE IF NOT EXISTS `{PREFIX}guilds_ranks_permissions` (
--    node VARCHAR(50) NOT NULL,
--    permission VARCHAR(100) NOT NULL
--) STRICT;
---- Map<String, BookChapter> book;
--CREATE TABLE IF NOT EXISTS `{PREFIX}guilds_book` (
...
--) STRICT;
---- Map<UUID, Mail> mails;
--CREATE TABLE IF NOT EXISTS `{PREFIX}guilds_mails` (
--    id UUID PRIMARY KEY NOT NULL,
--    guild UUID NOT NULL
--) STRICT;
