...
public class CommandAlly extends CastelCommand {
    public CommandAlly() {
        super("ally", true);
    }
    ...
    public @NotNull CommandResult executeX(@NonNull CommandContext context) {
        return RelationalCommandProcessor.execute(GuildRelation.ALLY, context, Lang.COMMAND_ALLY_ALLIES);
    }

    @Override
    public @NonNull List<String> tabComplete(@NonNull CommandTabContext context) {
        return RelationalCommandProcessor.tabComplete(GuildRelation.ALLY, context);
    }
}
